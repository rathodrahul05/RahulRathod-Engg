...
function AestroidCard(props) {
    ...
    return (
        ...
        <div className="card-body">
         ...
         <p className="card-text"><b>Aestroid Id: </b>{props.aestroidDetails.aestroid_id}</p>
          <p className="card-text"><b>Url: </b>{props.aestroidDetails.nasa_jpl_url}</p>
           <p className="card-text"><b>is Safe:</b> {!props.aestroidDetails.is_potentially_hazardous_asteroid
